 ...
 * 
 */
public class CheckingRecordsResponse extends Response {

	private int recordCount;// 审核中的数量

	private String resultDateStr; // 审核完成时间

	private List<ExamineRecoding> examineRecodList;
	...
	public List<ExamineRecoding> getExamineRecodList() {
		return examineRecodList;
	}

	public void setExamineRecodList(List<ExamineRecoding> examineRecodList) {
		this.examineRecodList = examineRecodList;
	}

	public static class ExamineRecoding {
