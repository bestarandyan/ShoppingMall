...
public class TaskListResponse extends Response implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private List<UserTaskListDetailResponse> userTaskList = new ArrayList<UserTaskListDetailResponse>();

	public List<UserTaskListDetailResponse> getUserTaskList() {
		return userTaskList;
	}

	public void setUserTaskList(List<UserTaskListDetailResponse> userTaskList) {
		this.userTaskList = userTaskList;
	}

	public static class UserTaskListDetailResponse implements Serializable {
