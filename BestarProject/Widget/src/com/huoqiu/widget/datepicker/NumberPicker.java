...
public class NumberPicker extends LinearLayout {
	...
	public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
		...
		// R.layout.number_picker, DEFAULT_LAYOUT_RESOURCE_ID);
		...
		inflater.inflate(DEFAULT_LAYOUT_RESOURCE_ID, this, true);
	...
	public void setOnInputTextValueChangedListener(
			OnInputTextValueChangedListener onInputTextValueChangedListener) {
...
//		System.out.println("Layout InputText: " + inptTxtLeft + ":"
//				+ inptTxtTop + ":" + inptTxtRight + ":" + inptTxtBottom);
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		mInputText.measure(widthSize, heightSize);
	}
	...
	public boolean onInterceptTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN: {
			removeAllCallbacks();
//			System.out.println("Set Invisible by onInterceptTouchEvent");
...
//		System.out.println("Action :" + action);
	 ...
	 * (eventY > mBottomSelectionDividerBottom) { hoveredVirtualViewId =
	 * AccessibilityNodeProviderImpl.VIRTUAL_VIEW_ID_INCREMENT; } else {
	 * hoveredVirtualViewId =
	 * AccessibilityNodeProviderImpl.VIRTUAL_VIEW_ID_INPUT; } final int action =
	 * event.getActionMasked(); AccessibilityNodeProviderImpl provider =
	 * (AccessibilityNodeProviderImpl) getAccessibilityNodeProvider(); switch
	 * (action) { case MotionEvent.ACTION_HOVER_ENTER: {
	 * provider.sendAccessibilityEventForVirtualView(hoveredVirtualViewId,
	 * AccessibilityEvent.TYPE_VIEW_HOVER_ENTER); mLastHoveredChildVirtualViewId
	 * = hoveredVirtualViewId; provider.performAction(hoveredVirtualViewId,
	 * AccessibilityNodeInfo.ACTION_ACCESSIBILITY_FOCUS, null); } break; case
	 * MotionEvent.ACTION_HOVER_MOVE: { if (mLastHoveredChildVirtualViewId !=
	 * hoveredVirtualViewId && mLastHoveredChildVirtualViewId != View.NO_ID) {
	 * provider.sendAccessibilityEventForVirtualView(
	 * mLastHoveredChildVirtualViewId, AccessibilityEvent.TYPE_VIEW_HOVER_EXIT);
	 * provider.sendAccessibilityEventForVirtualView(hoveredVirtualViewId,
	 * AccessibilityEvent.TYPE_VIEW_HOVER_ENTER); mLastHoveredChildVirtualViewId
	 * = hoveredVirtualViewId; provider.performAction(hoveredVirtualViewId,
	 * AccessibilityNodeInfo.ACTION_ACCESSIBILITY_FOCUS, null); } } break; case
	 ...
	 * provider.sendAccessibilityEventForVirtualView(hoveredVirtualViewId,
	 * AccessibilityEvent.TYPE_VIEW_HOVER_EXIT); mLastHoveredChildVirtualViewId
	...
	private void showSoftInput() {
		...
		if (inputMethodManager != null) {
			if (mHasSelectorWheel) {
//				System.out.println("Set visible by showSoftInput");
	...
	private void hideSoftInput() {
		...
		if (inputMethodManager != null
			...
			if (mHasSelectorWheel) {
//				System.out.println("Set Invisible by hideSoftInput");
				mInputText.setVisibility(View.INVISIBLE);
			}
		}
	}
	...
	protected void onDraw(Canvas canvas) {
		...
		// mVirtualButtonPressedDrawable.setBounds(0, 0, mRight,
		...
		// mBottomSelectionDividerBottom, getRight(),
		// mBottom);
		// mVirtualButtonPressedDrawable.draw(canvas);
		// }
		// }
		...
		for (int i = 0; i < selectorIndices.length; i++) {
			...
			// with the new one.
//			System.out.println(mInputText.getText().toString() + " : "
//					+ mInputText.getVisibility());
	...
	private void changeValueByOne(boolean increment) {
		if (mHasSelectorWheel) {
//			System.out.println("Set Invisible by changeValueByOne");
			mInputText.setVisibility(View.INVISIBLE);
	...
	private boolean updateInputTextView() {
		...
		if (!TextUtils.isEmpty(text)
			...
			if (null != onInputTextValueChangedListener)
				onInputTextValueChangedListener.onValueChanged();
			return true;
		}
	...
	// return
	// createAccessibilityNodeInfoForVirtualButton(VIRTUAL_VIEW_ID_DECREMENT,
	...
	//
	// @Override
	// public List<AccessibilityNodeInfo>
	// findAccessibilityNodeInfosByText(String searched,
	// int virtualViewId) {
	// if (TextUtils.isEmpty(searched)) {
	// return Collections.emptyList();
	// }
	// String searchedLowerCase = searched.toLowerCase();
	// List<AccessibilityNodeInfo> result = new
	...
	//
	// @Override
	// public boolean performAction(int virtualViewId, int action, Bundle
	// arguments) {
	// switch (virtualViewId) {
	// case View.NO_ID: {
	// switch (action) {
	...
	//
	// @Override
	// public AccessibilityNodeInfo accessibilityFocusSearch(int direction, int
	// virtualViewId) {
	// switch (direction) {
	...
	// }
	//
	// public void sendAccessibilityEventForVirtualView(int virtualViewId, int
	// eventType) {
	// switch (virtualViewId) {
	// case VIRTUAL_VIEW_ID_DECREMENT: {
	// if (hasVirtualDecrementButton()) {
	...
	// }
	//
	// private void findAccessibilityNodeInfosByTextInChild(String
	// searchedLowerCase,
	...
	//
	// private AccessibilityNodeInfo
	// createAccessibilityNodeInfoForNumberPicker(int left, int top,
